...
<h2>
	...
	<?php if($data['side_menu']=="Gider Fatura Ayarları"){ echo'TÜM ÖDEMELER'; $tur="Ödeme"; } ?>
</h2>
...
<?php echo $n+1; ?> Tarih: <?php echo $dizi_odeme["tarih"]; ?>  Tutar: <?php echo $dizi_odeme["tutar"]." ".$this->session->userdata('para_birim'); $total=$total+$dizi_odeme["tutar"]; ?> Toplam <?php echo $tur; ?>: <?php echo $total." ".$this->session->userdata('para_birim'); ?>
<br><br>
</div>

		<?php	endforeach;  endif; ?>

	<?php if($total>$fat_toplam){  } 
else{
